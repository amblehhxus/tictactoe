...
const eventListener = (() => {
  ...
  var displayMainMenu = document.querySelector(".main-menu");
  var displayPVPSetting = document.querySelector(".pvp-setting");
  var displayAISetting = document.querySelector(".ai-setting");
  var displayGameSession = document.querySelector(".in-game");

  const buttonPVPSetting = document.querySelector(".pvp");
  const buttonAISetting = document.querySelector(".ai");
  
  // Show PVP or PVE setting
  buttonPVPSetting.addEventListener("click", function () {
    displayPVPSetting.style.display = "flex";
    displayMainMenu.style.display = "none";
  });

  buttonAISetting.addEventListener("click", function () {
    displayAISetting.style.display = "flex";
    displayMainMenu.style.display = "none";
    difficultySetting.className = "difficulty selected";
    difficultySetting.id = "dumb-ai";
  });
  
  // Enable or disable board drawing
  const enableDrawing = () => {
  ...
  const startGame = () => {
    enableDrawing();
    displayGameSession.style.display = "flex";
    displayMainMenu.style.display = "none";
    displayPVPSetting.style.display = "none";
    displayAISetting.style.display = "none";
...
const tictactoe = (() => {
  ...
  // Function for board winning stroke
  function stroke() {
  ...
  const checkWinner = () => {
    ...
    if (
      equals3(board[0], board[1], board[2]) ||
      equals3(board[0], board[3], board[6])
    ) {
      winner = board[0];
      stroke();
    }
    ...
    if (
      equals3(board[1], board[4], board[7]) ||
      equals3(board[3], board[4], board[5]) ||
      equals3(board[0], board[4], board[8]) ||
      equals3(board[2], board[4], board[6])
    ) {
      winner = board[4];
      stroke();
    }
    ...
    if (
      equals3(board[2], board[5], board[8]) ||
      equals3(board[6], board[7], board[8])
    ) {
      winner = board[8];
      stroke();
    }
...
for (let i = 0; i < 2; i++) {
  document.querySelectorAll(".start")[i].addEventListener("click", eventListener.startGame);
}
...
document
  ...
  .addEventListener("click", gameDisplay.restart);

document
  .querySelector(".next-round")
  .addEventListener("click", gameDisplay.nextRound);
